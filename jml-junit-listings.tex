% jml-junit-listings.tex
% listings configuration for JML and JUnit.
% Most of the package comes from JML 5.4 distribution.
...
%
\lstdefinelanguage[JUnit]{Java}[]{Java}{%
        classoffset=2,
        morekeywords={@Before,@After,@Test,@Suite,@RunWith,@Parameters,
        @DataPoint,@DataPoints,@Theory},
        classoffset=0 % restore default class for keywords
}

\lstdefinelanguage[JML+JUnit]{Java}[]{Java}%
       {% C++ style comments have to start with a blank!
        comment=[l]{//\ },
        % C-style comments must also start with a blank!
        morecomment=[s]{/*\ }{*/},
        % And javadoc-style comments must also start with a blank!
        morecomment=[s]{/**\ }{*/},
